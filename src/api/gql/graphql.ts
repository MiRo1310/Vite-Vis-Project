...
export type TravelCostFilterInput = {
  ...
  description?: StringOperationFilterInput | null | undefined;
  hasInvoice?: BooleanOperationFilterInput | null | undefined;
  id?: UuidOperationFilterInput | null | undefined;
  isValidated?: BooleanOperationFilterInput | null | undefined;
  modifiedAt?: DateTimeOperationFilterInput | null | undefined;
...
export type TravelCostSortInput = {
  ...
  hasInvoice?: SortEnumType | null | undefined;
  id?: SortEnumType | null | undefined;
  isValidated?: SortEnumType | null | undefined;
  modifiedAt?: SortEnumType | null | undefined;
...
export type UpdateTravelCostHasInvoiceMutationVariables = Exact<{
  id: string;
  hasInvoice: boolean;
}>;


export type UpdateTravelCostHasInvoiceMutation = { updateTravelCost: { id: string, hasInvoice: boolean | null } | null };

export type UpdateTravelCostIsValidatedMutationVariables = Exact<{
  id: string;
  isValidated: boolean;
}>;


export type UpdateTravelCostIsValidatedMutation = { updateTravelCost: { id: string, isValidated: boolean | null } | null };
...
export type TravelCostQuery = { travelCost: Array<{ id: string, addressId: string | null, date: string | null, description: string | null, isValidated: boolean | null, hasInvoice: boolean | null, price: number | null, address: { name: string | null, street: string | null, city: string | null } | null }> };
...
export const UpdateTravelCostHasInvoiceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateTravelCostHasInvoice"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"hasInvoice"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateTravelCost"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dto"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"hasInvoice"},"value":{"kind":"Variable","name":{"kind":"Name","value":"hasInvoice"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hasInvoice"}}]}}]}}]} as unknown as DocumentNode<UpdateTravelCostHasInvoiceMutation, UpdateTravelCostHasInvoiceMutationVariables>;
export const UpdateTravelCostIsValidatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateTravelCostIsValidated"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"isValidated"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateTravelCost"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dto"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"isValidated"},"value":{"kind":"Variable","name":{"kind":"Name","value":"isValidated"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"isValidated"}}]}}]}}]} as unknown as DocumentNode<UpdateTravelCostIsValidatedMutation, UpdateTravelCostIsValidatedMutationVariables>;
