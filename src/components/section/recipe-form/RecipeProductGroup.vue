...
import { type GetRecipeByIdQuery } from "@/api/gql/graphql";
...
import { fieldsRecipe, productSchema, type TProductHeaderSchema, type TProductSchema } from "@/components/section/recipe-form/schema.form.js";
