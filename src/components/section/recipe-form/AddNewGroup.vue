...
import { fieldsRecipe, type TProductHeaderSchema, type TProductSchema } from "@/components/section/recipe-form/schema.form.js";
...
<template>
  <div class="flex justify-end">
    <Button class="mt-2" variant="outline" v-e2e="'recipe-add-product-group'" @click.prevent="addNewProductGroup">Neue Produktgruppe anlegen</Button>
  </div>
</template>
